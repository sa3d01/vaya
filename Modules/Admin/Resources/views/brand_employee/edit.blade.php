...
@section('title') Edit Brand Owner @endsection
@section('css')
...
@section('content')
 @component('admin::common-components.breadcrumb')
     ...
     @slot('li_1') Edit Brand Owner  @endslot
 @endcomponent
 @if($errors->any())
 ...
 @endif
 <form method="POST" action="{{route('admin.brand_owner.update',$row->id)}}" enctype="multipart/form-data" data-parsley-validate novalidate>
     @csrf
     @method('PUT')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input value="{{$row->name}}" required type="text" class="form-control" maxlength="50" name="name" id="alloptions" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">Email</label>
                            <input value="{{$row->email}}" required type="email" class="form-control" name="email"   />
                        </div>
                        <div class="form-group">
