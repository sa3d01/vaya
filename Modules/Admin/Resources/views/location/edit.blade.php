...
@section('content')
 @component('admin::common-components.breadcrumb')
     ...
     @slot('li_1') Edit location  @endslot
 @endcomponent
 @if($errors->any())
 ...
 @endif
 <form method="POST" action="{{route('admin.location.update',$row->id)}}" enctype="multipart/form-data" data-parsley-validate novalidate>
     @csrf
     @method('PUT')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input value="{{$row->title_ar}}" required type="text" class="form-control" maxlength="50" name="title_ar" id="alloptions" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">Name en</label>
                            <input value="{{$row->title_en}}" required type="text" class="form-control" maxlength="50" name="title_en" id="alloptions" />
                        </div>
                    </div>
                </div>
            </div>
